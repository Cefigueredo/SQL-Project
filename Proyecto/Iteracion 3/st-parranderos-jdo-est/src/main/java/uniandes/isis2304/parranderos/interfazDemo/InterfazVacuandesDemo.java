...
//TODO terminar los demos
    
	/* ****************************************************************
	 * 			Demos de Vacunacion
	 *****************************************************************/
    /**
     * Demostración de creación, consulta y borrado de vacunaciones
     * Muestra la traza de la ejecución en el panelDatos
     * 
     * Pre: La base de datos está vacía
     * Post: La base de datos está vacía
     */
    public void demoVacunacion( )
    {
		try 
		{
    		// Ejecución de la demo y recolección de los resultados
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			VOVacunacion vacunacion1 = vacuandes.adicionarVacunacion(30000000, 200000, 1342, 1);
			List <VOVacunacion> lista = vacuandes.darVOVacunaciones();
			long vacunacionesEliminadas = vacuandes.eliminarVacunacionPorId(1);
			
			// Generación de la cadena de caracteres con la traza de la ejecución de la demo
			String resultado = "Demo de creación y listado de Vacunaciones\n\n";
			resultado += "\n\n************ Generando datos de prueba ************ \n";
			resultado += "Adicionada la vacunacion: " + vacunacion1+ "\n";
			resultado += "\n\n************ Ejecutando la demo ************ \n";
			resultado += "\n" + listarVacunaciones (lista);
			resultado += "\n\n************ Limpiando la base de datos ************ \n";
			resultado += vacunacionesEliminadas + " Vacunaciones eliminadas\n";
			resultado += "\n Demo terminada";
...
//TODO Terminar las listas
     ...
     * @param lista - La lista con las vacunaciones
    ...
    private String listarVacunaciones(List<VOVacunacion> lista) 
    {
    	...
    	int i = 1;
        for (VOVacunacion vacunacion: lista)
        {
        	resp += i++ + ". " + vacunacion.toString() + "\n";
        }
        return resp;
	}
