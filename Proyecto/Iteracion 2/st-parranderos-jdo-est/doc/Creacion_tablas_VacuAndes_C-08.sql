...
CREATE TABLE CIUDADANOS
    (ID NUMBER,
    NOMBRE VARCHAR2(50 BYTE) NOT NULL,
    DOCUMENTO VARCHAR2(10 BYTE) NOT NULL,
    ESTADOACTUAL NUMBER NOT NULL,
    FECHANACIMIENTO DATE NOT NULL,
    DIRECCION VARCHAR2(50 BYTE) NOT NULL,
    CIUDAD VARCHAR2(25 BYTE),
    NUMEROCONTACTO VARCHAR2(10 BYTE),
    IDVACUNACION NUMBER NOT NULL,
...
ALTER TABLE CIUDADANOS
    ADD CONSTRAINT CK_ESTADO_ACTUAL
    CHECK (ESTADOACTUAL BETWEEN 1 AND 9)
ENABLE;

ALTER TABLE CIUDADANOS
    ADD CONSTRAINT CK_NUMERO_CONTACTO
    CHECK (NUMEROCONTACTO > 0)
ENABLE;
...
ALTER TABLE ESTADO_PROCESO
    ADD CONSTRAINT CK_FECHA_CAMBIO
    CHECK (ESTADO IN ('EN_ESPERA','PENDIENTE_DE_CONTACTAR','NO_QUIERE_VACUNARSE',
        'FIRMA_CONSENTIMIENTO_INFORMADO','PUNTO_DE_VACUNACION_ASIGNADO',
        'CITA_AGENDADA','DOSIS_PENDIENTE','VACUNADO','NO_VACUNABLE'))
ENABLE;
